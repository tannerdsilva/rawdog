...
// @RAW_staticbuff_fixedwidthinteger_type<UInt8>(bits:8, bigEndian:true)
// fileprivate struct _UInt8:ExpressibleByIntegerLiteral {
...
// @RAW_staticbuff_fixedwidthinteger_type<UInt16>(bits:16, bigEndian:true)
// fileprivate struct _UInt16 {}
