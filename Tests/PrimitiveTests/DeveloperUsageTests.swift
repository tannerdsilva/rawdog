...
@RAW_staticbuff_fixedwidthinteger_type<Int64>(bits:64, bigEndian:true)
struct EncodedInt64 {}

extension Int64 {
	#RAW_staticbuff_binaryfloatingpoint_init<EncodedInt64>()
}
...
@RAW_staticbuff_concat_type(EncodedDouble, EncodedFloat)
fileprivate struct MYSTRUCT2 {
	internal var firstItem:EncodedDouble
	internal var secondItem:EncodedFloat
}
...
@RAW_staticbuff_concat_type(MyUInt16Equivalent, MyUInt32Equivalent, MyUInt64Equivalent)
...
@RAW_staticbuff_concat_type(EncodedUInt64, EncodedInt64)
struct MyDually {
...
final class TestDeveloperUsage:XCTestCase {
	func testConcatMemoryLayout() {
		typealias MyTestTYpe = (FixedBuff5, EncodedDouble, EncodedFloat, FixedBuff5)
		XCTAssertEqual(MemoryLayout<MYSTRUCT>.size, MemoryLayout<MYSTRUCT>.stride)
		XCTAssertEqual(MemoryLayout<MYSTRUCT>.alignment, 1)
		XCTAssertEqual(MemoryLayout<MYSTRUCT>.size, MemoryLayout<MyTestTYpe>.size)
