...
struct FixedBuff5:ExpressibleByArrayLiteral {
	var MyVar:String {
		return "lets get it"
	}
}

@RAW_staticbuff(concat:FixedBuff5, FixedBuff5)
struct MYConcatStruct {
	var myFirstComputed:String {
		return "foo"
	}
	var myTuple:FixedBuff5
	// var myFooBar:FixedBuff5
}
...
// @RAW_staticbuff_fixedwidthinteger_type(bits:16, bigEndian:true)
// @RAW_staticbuff(2)
