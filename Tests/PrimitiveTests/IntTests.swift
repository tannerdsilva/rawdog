...
// @RAW_staticbuff_fixedwidthinteger_type<Int8>(bits:8, bigEndian:true)
// fileprivate struct _Int8 {}
...
// @RAW_staticbuff_fixedwidthinteger_type<Int16>(bits:16, bigEndian:true)
// fileprivate struct _Int16 {}

// class RAWInt16Tests: XCTestCase {
// 	func testAsRAWVal() throws {
// 		let value: _Int16 = -512
// 		var countout:size_t = 0
// 		let bytes: [UInt8] = [UInt8](RAW_encodable:value, count_out:&countout)
...
// @RAW_staticbuff_fixedwidthinteger_type<Int32>(bits:32, bigEndian:true)
// fileprivate struct _Int32 {}

// class RAWInt32Tests: XCTestCase {
// 	func testAsRAWVal() throws {
// 		let value: _Int32 = -512
// 		var countout:size_t = 0
// 		let bytes: [UInt8] = [UInt8](RAW_encodable:value, count_out:&countout)
// 		let expectedBytes:[UInt8] = [0xFF, 0xFF, 0xFE, 0x00]
// 		XCTAssertEqual(bytes, expectedBytes)
