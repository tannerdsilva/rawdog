...
typedef sha512_state __crawdog_ed25519_hash_context;
...
static void
__crawdog_ed25519_hash_init(sha512_state *S) {
...
static void
__crawdog_ed25519_hash_update(sha512_state *S, const uint8_t *in, size_t inlen) {
	size_t blocks, want;
...
static void
__crawdog_ed25519_hash_final(sha512_state *S, uint8_t *hash) {
...
static void
__crawdog_ed25519_hash(uint8_t *hash, const uint8_t *in, size_t inlen) {
...
typedef SHA512_CTX __crawdog_ed25519_hash_context;

static void
__crawdog_ed25519_hash_init(__crawdog_ed25519_hash_context *ctx) {
	SHA512_Init(ctx);
}

static void
__crawdog_ed25519_hash_update(__crawdog_ed25519_hash_context *ctx, const uint8_t *in, size_t inlen) {
	SHA512_Update(ctx, in, inlen);
}

static void
__crawdog_ed25519_hash_final(__crawdog_ed25519_hash_context *ctx, uint8_t *hash) {
