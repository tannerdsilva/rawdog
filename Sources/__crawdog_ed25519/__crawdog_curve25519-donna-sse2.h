...
__crawdog_curve25519_copy(bignum25519 out, const bignum25519 in) {
	xmmi x0,x1,x2;
...
/* out = a + b */
DONNA_INLINE static void
__crawdog_curve25519_add(bignum25519 out, const bignum25519 a, const bignum25519 b) {
...
#define __crawdog_curve25519_add_after_basic __crawdog_curve25519_add_reduce
DONNA_INLINE static void
__crawdog_curve25519_add_reduce(bignum25519 out, const bignum25519 a, const bignum25519 b) {
	xmmi a0,a1,a2,b0,b1,b2;
	xmmi c1,c2,c3;
...
DONNA_INLINE static void
__crawdog_curve25519_sub(bignum25519 out, const bignum25519 a, const bignum25519 b) {
	xmmi a0,a1,a2,b0,b1,b2;
	xmmi c1,c2;
	xmmi r0,r1;
...
DONNA_INLINE static void
__crawdog_curve25519_sub_after_basic(bignum25519 out, const bignum25519 a, const bignum25519 b) {
	xmmi a0,a1,a2,b0,b1,b2;
	xmmi c1,c2,c3;
	xmmi r0,r1,r2,r3,r4,r5;
...
DONNA_INLINE static void
__crawdog_curve25519_sub_reduce(bignum25519 out, const bignum25519 a, const bignum25519 b) {
	xmmi a0,a1,a2,b0,b1,b2;
	xmmi c1,c2,c3;
	xmmi r0,r1,r2,r3,r4,r5;
...
DONNA_INLINE static void
__crawdog_curve25519_neg(bignum25519 out, const bignum25519 b) {
	xmmi a0,a1,a2,b0,b1,b2;
	xmmi c1,c2,c3;
	xmmi r0,r1,r2,r3,r4,r5;
...
static void 
__crawdog_curve25519_mul(bignum25519 out, const bignum25519 r, const bignum25519 s) {
...
__crawdog_curve25519_mul_noinline(bignum25519 out, const bignum25519 r, const bignum25519 s) {
	__crawdog_curve25519_mul(out, r, s);
}

#define __crawdog_curve25519_square(r, n) __crawdog_curve25519_square_times(r, n, 1)
static void
__crawdog_curve25519_square_times(bignum25519 r, const bignum25519 in, int count) {
	xmmi m01,m23,m45,m67,m89;
...
DONNA_INLINE static void
__crawdog_curve25519_tangle32(packedelem32 *out, const bignum25519 x, const bignum25519 z) {
...
DONNA_INLINE static void
__crawdog_curve25519_untangle32(bignum25519 x, bignum25519 z, const packedelem32 *in) {
...
DONNA_INLINE static void
__crawdog_curve25519_add_reduce_packed32(packedelem32 *out, const packedelem32 *r, const packedelem32 *s) {
	xmmi r0,r1,r2,r3,r4;
...
DONNA_INLINE static void
__crawdog_curve25519_add_packed32(packedelem32 *out, const packedelem32 *r, const packedelem32 *s) {
...
DONNA_INLINE static void
__crawdog_curve25519_sub_packed32(packedelem32 *out, const packedelem32 *r, const packedelem32 *s) {
	xmmi r0,r1,r2,r3,r4;
	xmmi s0,s1,s2,s3;
	xmmi c1,c2;
...
DONNA_INLINE static void
__crawdog_curve25519_sub_after_basic_packed32(packedelem32 *out, const packedelem32 *r, const packedelem32 *s) {
	xmmi r0,r1,r2,r3,r4;
	xmmi s0,s1,s2,s3,s4,s5;
	xmmi c1,c2;
...
DONNA_INLINE static void
__crawdog_curve25519_tangle64_from32(packedelem64 *a, packedelem64 *b, const packedelem32 *c, const packedelem32 *d) {
...
DONNA_INLINE static void
__crawdog_curve25519_tangle64(packedelem64 *out, const bignum25519 x, const bignum25519 z) {
...
DONNA_INLINE static void
__crawdog_curve25519_tangleone64(packedelem64 *out, const bignum25519 x) {
	xmmi x0,x1,x2;
...
DONNA_INLINE static void
__crawdog_curve25519_swap64(packedelem64 *out) {
...
DONNA_INLINE static void
__crawdog_curve25519_untangle64(bignum25519 x, bignum25519 z, const packedelem64 *in) {
...
DONNA_INLINE static void
__crawdog_curve25519_mul_packed64(packedelem64 *out, const packedelem64 *r, const packedelem64 *s) {
...
DONNA_INLINE static void
__crawdog_curve25519_square_packed64(packedelem64 *out, const packedelem64 *r) {
	xmmi r0,r1,r2,r3;
...
static void
__crawdog_curve25519_expand(bignum25519 out, const unsigned char in[32]) {
 ...
 */
static void
__crawdog_curve25519_contract(unsigned char out[32], const bignum25519 in) {
	bignum25519 ALIGN(16) f;
	__crawdog_curve25519_copy(f, in);
...
/* if (iswap) swap(a, b) */
DONNA_INLINE static void
__crawdog_curve25519_swap_conditional(bignum25519 a, bignum25519 b, uint32_t iswap) {
...
/* out = (flag) ? out : in */
DONNA_INLINE static void
__crawdog_curve25519_move_conditional_bytes(uint8_t out[96], const uint8_t in[96], uint32_t flag) {
