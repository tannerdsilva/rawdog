...
/* out = a * b */
#define __crawdog_curve25519_mul_noinline __crawdog_curve25519_mul
static void
__crawdog_curve25519_mul(bignum25519 out, const bignum25519 a, const bignum25519 b) {
...
/* out = in ^ (2 * count) */
static void
__crawdog_curve25519_square_times(bignum25519 out, const bignum25519 in, int count) {
	uint32_t r0,r1,r2,r3,r4,r5,r6,r7,r8,r9;
	uint32_t d6,d7,d8,d9;
	uint64_t m0,m1,m2,m3,m4,m5,m6,m7,m8,m9,c;
	uint32_t p;
