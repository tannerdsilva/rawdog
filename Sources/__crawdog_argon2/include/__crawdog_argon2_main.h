 ...
 */
__CRAWDOG_ARGON2_PUBLIC const char *__crawdog_argon2_type2string(argon2_type type, int uppercase);
 ...
 */
__CRAWDOG_ARGON2_PUBLIC int __crawdog_argon2_ctx(__crawdog_argon2_context *context, argon2_type type);
